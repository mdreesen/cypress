...
describe('Cypress', () => {
  ...
  describe('Movies',function() {
      it('verifys the movies browse page',function() {
        ...
        cy.visit("https://www-dev.private.hoopladigital.com/browse/movie/popular?page=1")
        cy.wait(8000)

        cy.url().should('contain', 'https://www-dev.private.hoopladigital.com/browse/movie/popular?page=1')
        cy.wait(2000)

        // Looking for Recommended, Featrued, Popular, Categories links
        cy.get('.sc-htpNat').should('be.visible') // Moves header
        cy.get('[aria-label="Click to view recommended movie titles"] > span').should('be.visible') // Recommended link
        cy.get('[aria-label="Click to view featured movie titles"] > span').should('be.visible') // Featured link
        cy.get('[aria-label="Click to view movie categories"] > span').should('be.visible') // Categories link
        ...
        cy.get('[aria-label="Click to view recommended movie titles"] > span').click() // Clicks on Recommended
        cy.url().should('include', 'https://www-dev.private.hoopladigital.com/browse/movie/recommended?page=1')
        cy.get('[aria-label="Click to view featured movie titles"] > span').click() // Clicks on Featured
        cy.url().should('include', 'https://www-dev.private.hoopladigital.com/browse/movie/featured?page=1')
        cy.get('[aria-label="Click to view popular movie titles"] > span').click() // Clicks on Popular
        cy.url().should('include', 'https://www-dev.private.hoopladigital.com/browse/movie/popular?page=1')
        cy.get('[aria-label="Click to view movie categories"] > span').click() // Clicks on Categories
        cy.url().should('include', 'https://www-dev.private.hoopladigital.com/browse/movie/categories?page=1')
       ...
       // Featured page
       cy.visit("https://www-dev.private.hoopladigital.com/browse/movie/featured?page=1")
       ...
       // Recommended page
       cy.visit("https://www-dev.private.hoopladigital.com/browse/movie/recommended?page=1")
       cy.wait(8000)
